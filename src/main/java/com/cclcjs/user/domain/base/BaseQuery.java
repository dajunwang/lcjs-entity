package com.cclcjs.user.domain.base;
...
public class BaseQuery {
    ...
    protected transient Integer startIndex;// 开始索引

    protected transient Integer pageSize;// 每页条数 添加分页查询的页码大小

    protected transient Integer endIndex;// 结束索引

    protected transient String orderField;// 排序字段

    protected transient String orderFieldType;// 排序字段类型

    protected transient Map<String, Object> queryData;// 查询扩展

    protected transient String keyword;// 关键则查询
